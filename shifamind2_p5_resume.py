...
print("="*80)
print("🚀 PHASE 5 - RESUME BASELINE TRAINING")
print("="*80)
...
if not fair_results_path.exists():
    print(f"❌ Fair comparison results not found!")
    sys.exit(1)
...
print("\n" + "="*80)
print("📍 LOADING EXISTING BASELINES & TRAINING REMAINING")
print("="*80)
...
print("\n" + "="*80)
print("🔵 MultiResCNN - Training from scratch...")
print("="*80)
train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True)
...
# 4. LAAT - TRAIN
print("\n" + "="*80)
print("🔵 LAAT - Training from scratch...")
print("="*80)
...
# 5. PLM-ICD - TRAIN
print("\n" + "="*80)
print("🔵 PLM-ICD - Training from scratch...")
print("="*80)
...
print("\n" + "="*80)
print("🔵 Longformer-ICD - Training from scratch...")
print("="*80)
